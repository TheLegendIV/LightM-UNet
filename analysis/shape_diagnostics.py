...
Usage:
    python analysis/shape_diagnostics.py --net-name ENetGlobalCtxG3
    python analysis/shape_diagnostics.py --net-name ENetE1 --catheter-threshold 0.6

Writes analysis/results/{net_name}_shape_diagnostics.csv (per image) and
analysis/results/{net_name}_shape_diagnostics_overall.csv (mean across images).
"""
...
def main() -> None:
    ...
    parser.add_argument("--out-dir", type=Path, default=REPO_ROOT / "analysis" / "results")
