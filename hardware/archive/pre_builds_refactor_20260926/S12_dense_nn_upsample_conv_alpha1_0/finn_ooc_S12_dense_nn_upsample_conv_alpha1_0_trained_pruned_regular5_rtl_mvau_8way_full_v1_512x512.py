...
Run inside the FINN container (after the trained_pruned_regular5_512x512
preamble has completed):
    docker exec -e HOME=/tmp/home_dir <container> bash -c \\
        'cd /home/thelegendiv/finn/notebooks/enet && \\
         nohup python3 finn_ooc_S12_dense_nn_upsample_conv_alpha1_0_trained_pruned_regular5_rtl_mvau_8way_full_v1_512x512.py \\
           finn_deployment_outputs/S12_dense_nn_upsample_conv_alpha1_0_trained_pruned_regular5_rtl_mvau_512x512_preamble_<timestamp> \\
         > /tmp/S12_dense_nn_upsample_conv_alpha1_0_trained_pruned_regular5_rtl_mvau_8way_full_v1_512x512.log 2>&1 & disown'
"""
...
# REAL TRAINED checkpoint export, with `regular5.0` pruned out of the graph
# entirely (BOTTLENECKS_PER_STAGE n5=0 -- judged useless, per explicit
# instruction). See finn_export_S12_dense_nn_upsample_conv_alpha1_0_trained_
# pruned_regular5.py / finn_hawq_dump_conv_order_S12_dense_nn_upsample_conv_
# alpha1_0_trained_pruned_regular5.py for how these were produced.
MODEL_NAME = "quantEnet_S12_dense_nn_upsample_conv_alpha1.0_trained_pruned_regular5_int8_512x512"
CONV_ORDER_FILE = os.path.join(base.ENET_DIR, "quantEnet_S12_dense_nn_upsample_conv_alpha1.0_trained_pruned_regular5_int8_conv_order.json")
...
# same finn_build_tmp/ root. Distinct from the plain-dummy build's own
# S12_dense_nn_upsample_conv_v1/ subfolder (pruned graph has fewer nodes,
# must not reuse/clobber the dummy build's partition dirs).
_BASE_BUILD_DIR = "/home/thelegendiv/finn/notebooks/enet/finn_build_tmp/S12_dense_nn_upsample_conv_trained_pruned_v1"
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: finn_ooc_S12_dense_nn_upsample_conv_alpha1_0_trained_pruned_regular5_rtl_mvau_8way_full_v1_512x512.py "
    ...
    if len(sys.argv) >= 3:
        ...
        OUTPUT_DIR = os.path.join(
            ...
            f"S12_dense_nn_upsample_conv_alpha1_0_trained_pruned_regular5_rtl_mvau_8way_full_v1_512x512_{timestamp}",
        )
