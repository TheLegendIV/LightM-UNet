...
8_2_relu_no_reg_w20 model (`FINNQuantENet8w20HAWQ`, from
finn_export_8_2_relu_no_reg_w20_hawq.py), in `named_modules()` registration
order -- see hardware/finn_hawq_dump_conv_order.py (the S19 original this
mirrors) for the full rationale.

Usage (run inside the pytorch training container):
    python hardware/finn_hawq_dump_conv_order_8_2_relu_no_reg_w20.py

Output: hardware/outputs/finn_exports/quantEnet_8_2_relu_no_reg_w20_acc2x_hawq_dummy_conv_order.json
"""
...
from finn_export_8_2_relu_no_reg_w20_hawq import (  # noqa: E402
    FINNQuantENet8w20HAWQ,
...
def main() -> None:
    ...
    out_path = OUT_DIR / "quantEnet_8_2_relu_no_reg_w20_acc2x_hawq_dummy_conv_order.json"
