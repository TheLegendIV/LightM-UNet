...
context-block probe pair at INT8 -- see finn_export_probe_s12_context_common.py
for the shared network/estimate/export logic, and
finn_export_probe_s12_context_separable_int8.py for its matched counterpart.

Usage:
    python3 finn_export_probe_s12_context_dense_int8.py
"""
import sys
...
MODEL_NAME = "probe_s12_context_dense_int8"
BIT_WIDTH = 8
