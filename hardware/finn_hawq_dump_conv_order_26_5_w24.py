"""Same as finn_hawq_dump_conv_order.py, but for the fresh-weight,
per-block-HAWQ-bit-width, per-block-leaky 26_5_w24 JOINT export
(FINNQuantENet26_5_w24HAWQ, from finn_export_26_5_w24_hawq_joint.py).

Usage (run inside the pytorch training container):
    python hardware/finn_hawq_dump_conv_order_26_5_w24.py

Output: hardware/outputs/finn_exports/quantEnet_26_5_w24_hawq_joint_int8_conv_order.json
"""
...
from finn_export_26_5_w24_hawq_joint import (  # noqa: E402
    FINNQuantENet26_5_w24HAWQ,
...
def main() -> None:
    ...
    out_path = OUT_DIR / "quantEnet_26_5_w24_hawq_joint_int8_conv_order.json"
