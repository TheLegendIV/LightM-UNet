...
d2_projected (native width, channels 4,16,32,16,4, compression/results.csv's
own 8_2_relu_no_reg_d2_projected_fullwidth row, dice=0.794). See
...
channels (native width 32 instead of width-24).

Usage:
    python compression/folding_8_2_relu_no_reg_d2_projected.py
"""
...
def main() -> None:
    ...
    out_file = REPO_ROOT / "compression" / "hawq" / "folding_8_2_relu_no_reg_d2_projected_int8_100pct.json"
