"""Real folding ILP feasibility check for nnUNetTrainerENet_8_2_relu_no_reg_
fullwidth (native width, channels 4,16,32,16,4, plain context_pattern=
dense_dilation -- no reg bookends, no d2-projection, compression/
results.csv's own 8_2_relu_no_reg_fullwidth row, dice=0.802). See
compression/folding_8_2_relu_w24_no_reg_d2_projected.py for the full
rationale -- identical mechanism, this file's CONFIG differs only in
channels/context_pattern to match this architecture.

Usage:
    python compression/folding_8_2_relu_no_reg_fullwidth.py
"""
...
CONFIG = dict(
    ...
    use_dsc=False, context_pattern="dense_dilation", use_prelu=False,
...
def main() -> None:
    ...
    out_file = REPO_ROOT / "compression" / "hawq" / "folding_8_2_relu_no_reg_fullwidth_int8_100pct.json"
