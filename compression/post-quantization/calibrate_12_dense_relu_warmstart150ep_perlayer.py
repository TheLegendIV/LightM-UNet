"""Builds nnUNetTrainerENet_12_dense_relu_warmstart150ep's own real per-LAYER
...
context pattern, no reg-trailing block -- see MILP/
config_12_dense_relu_warmstart150ep.py).

Output checkpoint is meant as the WARM START for
nnUNetTrainerLayerQuantENet_12_dense_relu_warmstart150ep_perlayer's own real
...
def main() -> None:
    ...
    parser.add_argument("--source-net-name", default="nnUNetTrainerENet_12_dense_relu_warmstart150ep")
    ...
    new_checkpoint["trainer_name"] = "nnUNetTrainerLayerQuantENet_12_dense_relu_warmstart150ep_perlayer"
