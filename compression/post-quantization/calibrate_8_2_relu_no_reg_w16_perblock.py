"""Builds nnUNetTrainerENet_8_2_relu_no_reg_w16's own real per-BLOCK HAWQ-
...
saving -- same rationale/mechanism as calibrate_8_2_relu_no_reg_w20_
...
net's own channels=(4,8,16,8,4) width.
...
nnUNetTrainerCombinedQuantENet_8_2_relu_no_reg_w16_perblock's own real QAT
...
def main() -> None:
    ...
    parser.add_argument("--source-net-name", default="nnUNetTrainerENet_8_2_relu_no_reg_w16")
    ...
    new_checkpoint["trainer_name"] = "nnUNetTrainerCombinedQuantENet_8_2_relu_no_reg_w16_perblock"
