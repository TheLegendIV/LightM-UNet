"""Builds nnUNetTrainerENet_26_10_w24_s14w12_relu's own real per-BLOCK
...
saving -- same rationale/mechanism as
...
Architecture: channels=(4,12,24,12,4), dense_dilation context,
separable_dilated=True (dense (k,1)+(1,k) two-pass dilated-conv factoring,
NOT depthwise/DSC -- use_dsc=False, dsc_no_projection=False throughout,
real projected RegularBottleneck everywhere), plain ReLU.
...
and can be passed straight through, same as every other per-block
calibration script this session.

Output checkpoint is meant as the WARM START for
nnUNetTrainerCombinedQuantENet_26_10_w24_s14w12_relu_perblock's own real
...
def main() -> None:
    ...
    parser.add_argument("--source-net-name", default="nnUNetTrainerENet_26_10_w24_s14w12_relu")
    ...
    new_checkpoint["trainer_name"] = "nnUNetTrainerCombinedQuantENet_26_10_w24_s14w12_relu_perblock"
