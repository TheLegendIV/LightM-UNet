...
def main():
    ...
    configuration = "2d"
    fold = 0
    trainer_name = "nnUNetTrainerLightMUNet16v1"
    ...
    print("Model init_filters:", getattr(model, "init_filters", "N/A"))
    print("Model blocks_down:", getattr(model, "blocks_down", "N/A"))
    print("Model blocks_up:", getattr(model, "blocks_up", "N/A"))
