    ...
    def forward(
        ...
        if indices is None:
            ...
            if main.shape[1] != indices.shape[1]:
                raise RuntimeError(
                    "ENetOriginal max-unpool channel mismatch: "
            ...
            try:
                ...
                raise RuntimeError(
                    "ENetOriginal max-unpool failed. The paper-faithful decoder requires the nnU-Net "
        ...
        if out.shape[2:] != main.shape[2:]:
            raise RuntimeError(
                "ENetOriginal upsampling branch shape mismatch. The paper-faithful decoder produced "
