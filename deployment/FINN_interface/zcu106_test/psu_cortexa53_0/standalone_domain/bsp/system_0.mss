...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = idma0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = odma0
END
...
BEGIN LIBRARY
 ...
 PARAMETER PROC_INSTANCE = psu_cortexa53_0
 PARAMETER arp_queueing = true
 PARAMETER ip_frag = true
 PARAMETER ip_reassembly = true
 PARAMETER memp_n_tcp_seg = 512
 PARAMETER no_sys_no_timers = false
 PARAMETER tcp_queue_ooseq = true
